...
import { adminCreateProblemAction } from "@/components/actions/admin-actions";
  ...
  return (
    <Card className="bg-card/80">
      <CardHeader>
        ...
        <CardDescription>
          Add a new problem with platform mapping and publish control.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form ref={formRef} action={formAction} className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              {state.errors?.source && (
                <p className="text-sm text-red-600">{state.errors.source[0]}</p>
              )}
            </div>
          </div>
