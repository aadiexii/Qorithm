...
import {
  adminDeleteProblemAction,
  togglePublishAction,
} from "@/components/actions/admin-actions";
                  ...
                  <TableRow key={p.id}>
                    <TableCell className="font-medium">
                        ...
                        {p.isPublished && (
                          <div className="flex gap-1">
                            {!p.rating && !p.externalDifficulty && (
                              <span
                                className="rounded bg-rose-500/20 px-1.5 py-0.5 text-[10px] font-bold text-rose-500"
                            ...
                            {p.problemTopics.length === 0 && (
                              <span
                                className="rounded bg-amber-500/20 px-1.5 py-0.5 text-[10px] font-bold text-amber-500"
                      ...
                      {p.platform !== "custom" && p.externalContestId && (
                        <div className="text-muted-foreground text-xs">
                          {p.platform}:{p.externalContestId}/
