  ...
  return (
    <Card className="bg-card/80">
      <CardHeader>
        ...
        <CardDescription>
          Paste CSV with columns: title, source, rating, platform,
          externalContestId, externalProblemIndex, topics, isPublished
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {result && (
          <div
            className={`rounded-md p-4 text-sm ${result.success ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
          >
