  ...
  useEffect(() => {
    ...
    const draw = (currentTime: number) => {
      ...
      for (const dot of dots) {
        ...
        const randomFactor =
          Math.sin((i * 12.9898 + j * 78.233) * 43758.5453) * 0.5 + 0.5;
        ...
        if (shouldSnap) {
          ...
          if (
            Math.abs(dot.x - targetX) > 100 ||
            Math.abs(dot.y - targetY) > 100
          ) {
            dot.x = targetX;
            dot.y = targetY;
          }
