...
export const sheetSectionProblems = pgTable(
  ...
  (table) => ({
    ...
    sectionOrderUniq: uniqueIndex(
      "sheet_section_problems_section_order_idx",
    ).on(table.sectionId, table.orderIndex),
    sectionIdIdx: index("sheet_section_problems_section_id_idx").on(
      table.sectionId,
    ),
    problemIdIdx: index("sheet_section_problems_problem_id_idx").on(
      table.problemId,
    ),
  }),
);
...
export const sheetSectionProblemsRelations = relations(
